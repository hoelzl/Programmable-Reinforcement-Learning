...
(defclass <holyq> (<alisp-learning-algorithm> <q-learning-algorithm>)
  ...
  (:documentation "Class <holyq>
Does hierarchical q-learning, using the 2.5-part decomposition Q = Qr + Qc + PeV
...
(defmethod print-object ((alg <holyq>) str)
  (print-unreadable-object (alg str)
    (format str "with ~A choice stack items" (length (choice-stack alg)))))
