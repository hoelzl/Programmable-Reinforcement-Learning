...
(defclass <linear-fn-approx> (<fn-approx>)
  ((params :type vector)
   (dim :type fixnum
	...
	:reader dim))
  (:documentation "Class <linear-fn-approx> (<fn-approx>)
Class for linear function approximation.
...
(defmethod initialize-instance :after ((fa <linear-fn-approx>) &rest initargs)
  (declare (ignore initargs))
  (let ((unbound (not (slot-boundp fa 'params))))
    (assert (or unbound (= (length (params fa)) (dim fa))) ()
