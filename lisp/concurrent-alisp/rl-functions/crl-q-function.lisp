...
(defclass <calisp-crl-q-function> (crlq:<crl-q-function> <calisp-q-function>)
  ...
  (:documentation "Class <calisp-q-function> (<crl-q-function> <calisp-q-function>)

Concurrent ALisp Q-function which is also a crl (coordinated relational linear) q-function (see
<crl-q-function> class for details).  This allows maximization and exploration to be done
efficiently.
...
(defclass <threadwise-q-function> (<decomposed-q-function> <calisp-q-function>)
  ...
  (:documentation
   "Class <threadwise-q-function> (<decomposed-q-function> <calisp-q-function>)

A calisp q-function that is also a decomposed q-function, and for which there's one component
per thread id at a state.  An abstract class because it doesn't actually define what the
q-components are.  See also the <threadwise-crl-q-function> subclass."))

(defclass <temporal-q-function> (<decomposed-q-function> <calisp-q-function>)
  ((component-fn :initform #'temporal-comps))
  (:documentation "<temporal-q-function> (<decomposed-q-function> <calisp-q-function>)

A calisp q-function that is also a decomposed q-function, and for which there's one component
for each thread-temporal-component pair.  An abstract class because it doesn't actually define
what the q-components are.  See also the <temporal-crl-q-function> subclass."))

(defclass <threadwise-crl-q-function>
    (<decomposed-crl-q-function> <threadwise-q-function> <calisp-crl-q-function>)
  ()
  (:documentation
   "Class <threadwise-crl-q-function> (<decomposed-crl-q-function> <threadwise-crl-q-function>
                                    <calisp-crl-q-function>)"))

(defclass <temporal-crl-q-function>
    (<decomposed-crl-q-function> <temporal-q-function> <calisp-crl-q-function>)
  ()
  (:documentation
   "Class <temporal-crl-q-function> (<decomposed-crl-q-function> <temporal-q-function>
                                  <calisp-crl-q-function>)"))
...
A macro for defining feature templates.  Expands to code that evaluates to a function that
depends on a single argument called VAR-NAME.  The macro sets up various lexical bindings so
that feature template descriptions that use make-feature-temp can be easier to read - see
use-calisp-bindings for details."
...
Works analogously to make-feature-template, except that it creates a function depending on *two*
arguments - STATE-VAR-NAME and ID-VAR-NAME, representing the joint state and component ID.  The
lexical bindings are the same as in make-feature-template."
...
Makes NAME fbound to a function of one argument, JS-VAR, created using make-feature-template
applied to the remaining arguments.  The optional DOC-STRING is empty if not supplied."
...
Makes NAME fbound to a function of two arguments - JS-VAR and ID-VAR (unevaluated symbols) -
created using make-decomposed-feature-template applied to the remaining arguments.  The optional
DOC-STRING is empty if not supplied."
