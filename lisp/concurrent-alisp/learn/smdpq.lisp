...
(defpackage #:calisp-smdpq
  (:nicknames #:csq)
  (:documentation "Package calisp-smdpq
The smdp q-learning algorithm, applied to concurrent alisp. 
...
Subclass of <calisp-learning-algorithm> that uses SMDP Q-learning.
