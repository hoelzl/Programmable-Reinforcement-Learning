...
(defun topological-sort (parents)
  "topological-sort PARS
PARS is a vector of parent-index lists.  Return topological ordering.  E.g. if PARS is 
#((1 2) () (1)) then returns '(1 2 0).  The sort is also stable, i.e., if two variables are
incomparable, then the one with the smaller index comes first.  Assert if there's a cycle."
