...
(defgeneric vars (potential)
  (:documentation "vars POTENTIAL
Return list or vector of variables to which this potential refers."))
...
INST-SET   is the set of joint instantiations to all the variables (not just the ones referred to
           by POTENTIALS)
POTENTIALS is a list of potentials

Returns a new potential which depends on the union of the variables in the potentials, and which
represents the product of their functions.")
...
INST-SET        is the set of joint instantiations to all the variables (not just the ones
                referred to by POTENTIALS)
VAR-NAME        is the name of one of the variables
POTENTIALS      is a list of potentials.

Returns a new potential which depends on the union of the variables in the potentials minus
VAR-NAME.")
...
(defgeneric compose-potential (fn pot)
  (:documentation "compose-potential FUNCTION POTENTIAL
Return a new potential, which applies FUNCTION to the result of POTENTIAL."))
