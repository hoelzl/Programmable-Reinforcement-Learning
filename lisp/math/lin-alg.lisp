...
Return the l^p distance between two arrays of reals.  P is the norm to use. Either a positive
number, or the symbol 'infinity to indicate infinity-norm"))
...
;;
;; if a key occurs in h1 but not h2 (or vice versa) its value in h2 is assumed to be 0.
