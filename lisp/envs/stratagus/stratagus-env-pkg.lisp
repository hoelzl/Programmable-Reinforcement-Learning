...
Make specific stratagus subdomains by subclassing <stratagus-env>.  Subclasses should provide methods for is-terminal-state and compute-reward.")
  ...
  (:export #:make-stratagus-env
	   ...
	   #:*unit-archer* #:*unit-axethrower* #:*unit-mage* #:*unit-death-knigt*
           #:*unit-human-oil-tanker*
	   #:*unit-orc-oil-tanker* #:*unit-elven-destroyer* #:*unit-troll-destroyer*
           #:*unit-human-transport*
	   #:*unit-orc-transport* #:*unit-battleship* #:*unit-ogre-juggernaught*
           #:*unit-gnomish-submarine*
	   #:*unit-giant-turtle* #:*unit-gnomish-flying-machine* #:*unit-gobblin-zeppelin*
           #:*unit-gryphon-rider*
	   #:*unit-dragon* #:*unit-dwarves* #:*unit-goblin-sappers* #:*unit-gryphon-aviary*
           #:*unit-dragon-roost*
	   #:*unit-farm* #:*unit-pig-farm* #:*unit-human-barracks* #:*unit-orc-barracks*
           #:*unit-townhall* #:*unit-town-hall*
	   #:*unit-mine* #:*unit-gold-mine* #:*unit-elven-lumber-mill*
           #:*unit-troll-lumber-mill* #:*unit-stables*
	   #:*unit-ogre-mound* #:*unit-mage-tower* #:*unit-template-of-the-damned*
           #:*unit-human-foundry*
	   #:*unit-human-refinery* #:*unit-orc-foundry* #:*unit-orc-refinery*
           #:*unit-gnomish-inventor*
	   #:*unit-goblin-alchemist* #:*unit-church* #:*unit-altar-of-storms*
           #:*unit-human-watch-tower*
	   #:*unit-orc-watch-tower* #:*unit-great-hall* #:*unit-keep*
           #:*unit-stronghold* #:*unit-castle*
	   #:*unit-fortress* #:*unit-orc-blacksmith* #:*unit-human-blacksmith*
           #:*unit-human-shipyard*
	   #:*unit-orc-shipyard* #:*unit-human-wall* #:*unit-orc-wall*
           #:*unit-oil-patch* #:*unit-human-oil-platform*
	   #:*unit-orc-platform* 
	   #:*status-undefined*
	   #:*status-stop*
	   #:*status-move*
